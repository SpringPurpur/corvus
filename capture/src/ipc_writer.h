 ...
 *
 * The C engine is the socket client; Python inference is the server. This is
 * the reverse of the usual convention, but it simplifies lifecycle management:
 * the Python process owns the socket file and can be (re)started independently.
 *
