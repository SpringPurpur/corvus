/*
 * features.h — per-packet feature accumulation and flow finalisation.
 *
 ...
 * timeout). It runs the AVX2 routines over the accumulated buffers and
 * sets flow->complete = 1.
 */
#pragma once
 ...
 * statistics, set complete = 1.
 *
 * Must only be called once per flow. After this call the flow is ready to
